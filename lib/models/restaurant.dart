...
class Restaurant extends ChangeNotifier{
  ...
  final List<Food> _menu = [
    ...
    Food(
        ...
        description: "A juicy beef patty melted cheddar, lettuce, tomato, and a hint of onion and pickle.",
    ...
    Food(
        name: "Veggie Burger",
        description: "A hearty veggie patty topped with fresh avocado, lettuce, and tomato, served on a whole",
    ...
    Food(
        ...
        description: "Delight in the flavors of the East with this sesame-infused salad.",
